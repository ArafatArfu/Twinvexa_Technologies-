...
@section('page_title', \App\Models\Setting::get('homepage_title', 'Promotions & Deals'))

@section('content')
<main class="main">
    <div class="page-header text-center" style="background-image: url('{{ asset('assets/images/page-header-bg.jpg') }}')">
        <div class="container">
            <h1 class="page-title">{{ \App\Models\Setting::get('homepage_title', 'Promotions & Deals') }}<span>Shop</span></h1>
        </div>
    </div>
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ \App\Models\Setting::get('homepage_title', 'Promotions & Deals') }}</li>
            </ol>
        </div>
    </nav>
