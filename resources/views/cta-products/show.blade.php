...
@section('canonical_url', route('cta-products.show', $product->slug))
        ...
        <div class="container d-flex align-items-center">
            ...
            <nav class="product-pager ml-auto" aria-label="Product">
                @if($relatedProducts->isNotEmpty())
                    <a class="product-pager-link product-pager-prev" href="{{ route('cta-products.show', $relatedProducts->first()->slug) }}" aria-label="Previous" tabindex="-1">
                        <i class="icon-angle-left"></i>
                        <span>Prev</span>
                    </a>

                    <a class="product-pager-link product-pager-next" href="{{ route('cta-products.show', $relatedProducts->last()->slug) }}" aria-label="Next" tabindex="-1">
                        <span>Next</span>
                ...
                @forelse($relatedProducts as $relatedProduct)
                    ...
                    <div class="product product-7 text-center">
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="{{ route('products.show', $relatedProduct->slug) }}">{{ $relatedProduct->name }}</a></h3>
                            <div class="product-price">
                                @if(!$relatedProduct->isAvailable())
                            ...
                            <div class="product-nav product-nav-thumbs">
                                <a href="{{ route('products.show', $relatedProduct->slug) }}" class="active">
