...
@php
    $pageTitle = $product->meta_title ?: ($product->deal_label ? $product->deal_label . ' - ' : '') . $product->name;
...
@section('canonical_url', route('deals.show', $product->slug))
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container d-flex align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('deals.index') }}#deals-outlet">Deals & Outlet</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ $product->name }}</li>
            </ol>

            <nav class="product-pager ml-auto" aria-label="Product">
                @if($relatedProducts->isNotEmpty())
                    <a class="product-pager-link product-pager-prev" href="{{ route('deals.show', $relatedProducts->first()->slug) }}" aria-label="Previous" tabindex="-1">
                        <i class="icon-angle-left"></i>
                        <span>Prev</span>
                    </a>

                    <a class="product-pager-link product-pager-next" href="{{ route('deals.show', $relatedProducts->last()->slug) }}" aria-label="Next" tabindex="-1">
                        <span>Next</span>
                    ...
                    <div class="col-md-6">
                        <div class="product-details">
                            ...
                            <div class="ratings-container">
                                ...
                                <a class="ratings-text" href="#product-review-link">( {{ $product->review_count }} Reviews )</a>
                            </div>
                ...
                @forelse($relatedProducts as $relatedProduct)
                    ...
                    <div class="product product-7 text-center">
                        <figure class="product-media">
                            ...
                            @endif
                            <a href="{{ route('deals.show', $relatedProduct->slug) }}">
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="{{ route('deals.show', $relatedProduct->slug) }}">{{ $relatedProduct->name }}</a></h3>
                            <div class="product-price">
                                @if(!$relatedProduct->isAvailable())
                            ...
                            <div class="ratings-container">
                                <div class="ratings"><div class="ratings-val" style="width: {{ $relRating }}%;"></div></div>
                                <span class="ratings-text">( {{ $relReviews }} Reviews )</span>
                            </div>
                            <div class="product-nav product-nav-thumbs">
                                <a href="{{ route('deals.show', $relatedProduct->slug) }}" class="active">
