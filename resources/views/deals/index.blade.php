...
@section('page_title', \App\Models\Setting::get('deals_title', 'Deals & Outlet'))
@section('page_description', \App\Models\Setting::get('deals_description', 'Today\'s deal and more - Check out our latest deals and outlet offers.'))
@section('canonical_url', route('deals.index'))
@section('og_title', \App\Models\Setting::get('deals_title', 'Deals & Outlet'))
@section('og_description', \App\Models\Setting::get('deals_description', 'Today\'s deal and more'))
...
<main class="main">
    <div class="page-header text-center" style="background-image: url('{{ asset('assets/images/page-header-bg.jpg') }}')">
        <div class="container">
            <h1 class="page-title">{{ \App\Models\Setting::get('deals_title', 'Deals & Outlet') }}<span>Shop</span></h1>
        </div>
    </div>
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ \App\Models\Setting::get('deals_title', 'Deals & Outlet') }}</li>
            </ol>
        </div>
    </nav>
