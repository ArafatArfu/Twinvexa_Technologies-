...
@section('page_title', \App\Models\Setting::get('categories_title', 'Shop by Category'))

@push('css')
<link rel="stylesheet" href="{{ asset('assets/css/categories-pages-theme.css') }}">
@endpush
...
<main class="main">
    <div class="page-header text-center" style="background-image: url('{{ asset('assets/images/page-header-bg.jpg') }}')">
        <div class="container">
            <h1 class="page-title">{{ \App\Models\Setting::get('categories_title', 'Shop by Category') }}<span>Catalog</span></h1>
        </div>
    </div>
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ \App\Models\Setting::get('categories_title', 'Shop by Category') }}</li>
            </ol>
        </div>
    </nav>
