...
@section('canonical_url', route('new-arrivals.show', $product->slug))
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container d-flex align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/') }}#new-arrivals">New Arrivals</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ $product->name }}</li>
            </ol>

            <nav class="product-pager ml-auto" aria-label="Product">
                @if($relatedProducts->isNotEmpty())
                    <a class="product-pager-link product-pager-prev" href="{{ route('new-arrivals.show', $relatedProducts->first()->slug) }}" aria-label="Previous" tabindex="-1">
                        <i class="icon-angle-left"></i>
                        <span>Prev</span>
                    </a>

                    <a class="product-pager-link product-pager-next" href="{{ route('new-arrivals.show', $relatedProducts->last()->slug) }}" aria-label="Next" tabindex="-1">
                        <span>Next</span>
                        ...
                        <div class="product-gallery product-gallery-vertical">
                            <div class="row">
                                <figure class="product-main-image">
                                    ...
                                    @if($product->is_sale || $product->is_new || !$product->isAvailable())
                    ...
                    <div class="col-md-6">
                        <div class="product-details">
                            ...
                            <div class="product-details-action">
                                ...
                                <a href="{{ url('/') }}/compare/toggle/{{ $product->id }}" class="btn btn-outline-dark-3 icon-compare btn-compare-toggle" data-product-id="{{ $product->id }}" title="Add to Compare">
                ...
                @forelse($relatedProducts as $relatedProduct)
                    ...
                    <div class="product product-7 text-center">
                        <figure class="product-media">
                            ...
                            @endif
                            @if($relatedProduct->is_sale || ($relatedProduct->old_price && $relatedProduct->old_price > $relatedProduct->price))
                                <span class="product-label label-sale">Sale</span>
                            @endif
                            @if(!$relatedProduct->isAvailable())
                                <span class="product-label label-out">Out of Stock</span>
                            @endif
                            <a href="{{ route('new-arrivals.show', $relatedProduct->slug) }}">
                            ...
                            <div class="product-action-vertical">
                                ...
                                <a href="{{ url('/') }}/compare/toggle/{{ $relatedProduct->id }}" class="btn-product-icon btn-compare btn-compare-toggle" data-product-id="{{ $relatedProduct->id }}" title="Compare"><span>Compare</span></a>
                            </div>
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a href="{{ route('new-arrivals.show', $relatedProduct->slug) }}">{{ $relatedProduct->name }}</a></h3>
                            <div class="product-price">
                                @if(!$relatedProduct->isAvailable())
                            ...
                            <div class="product-nav product-nav-thumbs">
                                <a href="{{ route('new-arrivals.show', $relatedProduct->slug) }}" class="active">
...
(function($) {
    $(function() {
        ...
        $(document).on('click', '.btn-wishlist-toggle, .btn-compare-toggle', function(e) {
            e.preventDefault();
            var $btn = $(this);
