...
@section('page_title', \App\Models\Setting::get('site_name', 'Brands'))
@section('page_description', \App\Models\Setting::get('seo_description', 'Browse products by your favorite brands.'))
@section('canonical_url', route('brands.index'))
@section('og_title', \App\Models\Setting::get('site_name', 'Brands'))
@section('og_description', \App\Models\Setting::get('seo_description', 'Browse products by your favorite brands.'))
