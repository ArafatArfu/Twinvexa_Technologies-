    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="url" name="website_url" id="website_url" class="form-control @error('website_url') is-invalid @enderror" value="{{ old('website_url', $brand->website_url) }}" placeholder="https://example.com">
                @error('website_url')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>

            <div class="mb-3">
                <label for="short_description" class="form-label">Short Description</label>
                <textarea name="short_description" id="short_description" class="form-control @error('short_description') is-invalid @enderror" rows="2" placeholder="Brief brand summary...">{{ old('short_description', $brand->short_description) }}</textarea>
                @error('short_description')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>

            <div class="mb-3">
                <label for="description" class="form-label">Full Description</label>
                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="5" placeholder="Detailed brand description...">{{ old('description', $brand->description) }}</textarea>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <small class="text-muted">Recommended: 200 x 200 px. Max 4MB. Leave empty to keep current logo.</small>
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">Recommended: 1200 x 400 px. Max 4MB. Leave empty to keep current banner.</small>

                @if($brand->banner_image)
                    <div class="mt-3 d-flex align-items-center gap-3">
                        <img src="{{ asset('storage/' . $brand->banner_image) }}" alt="Brand Banner" width="200" class="img-thumbnail">
                        <div>
                            <label class="form-check">
                                <input type="checkbox" name="remove_banner_image" id="remove_banner_image" class="form-check-input" value="1">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="display_order" id="display_order" class="form-control @error('display_order') is-invalid @enderror" value="{{ old('display_order', $brand->display_order) }}">
            ...
            <div class="form-check">
                <input type="checkbox" name="is_featured" id="is_featured" class="form-check-input" value="1" {{ old('is_featured', $brand->is_featured) ? 'checked' : '' }}>
