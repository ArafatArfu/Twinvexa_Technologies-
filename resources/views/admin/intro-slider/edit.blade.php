...
<form action="{{ route('admin.intro-slider.update', $introSlider) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <textarea name="title" id="title" class="form-control @error('title') is-invalid @enderror" rows="2" required placeholder="Enter the main heading (use line breaks for multi-line titles)">{{ str_replace(['<br>', '<br/>', '<br />'], PHP_EOL, old('title', $introSlider->title)) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="subtitle" id="subtitle" class="form-control @error('subtitle') is-invalid @enderror" value="{{ old('subtitle', $introSlider->subtitle) }}" placeholder="e.g., New Arrival, Deals and Promotions">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="badge_text" id="badge_text" class="form-control @error('badge_text') is-invalid @enderror" value="{{ old('badge_text', $introSlider->badge_text) }}" placeholder="e.g., Sale, New, Top">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="badge_type" id="badge_type" class="form-control @error('badge_type') is-invalid @enderror">
                        ...
                        <option value="sale" {{ old('badge_type', $introSlider->badge_type) == 'sale' ? 'selected' : '' }}>Sale (Red)</option>
                        <option value="new" {{ old('badge_type', $introSlider->badge_type) == 'new' ? 'selected' : '' }}>New (Green)</option>
                        <option value="top" {{ old('badge_type', $introSlider->badge_type) == 'top' ? 'selected' : '' }}>Top (Blue)</option>
                    </select>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="button_url" id="button_url" class="form-control @error('button_url') is-invalid @enderror" value="{{ old('button_url', $introSlider->button_url) }}" placeholder="e.g., /shop or https://example.com">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                @if($introSlider->image_url)
                    <div class="mt-3">
                        <label class="form-label">Current Image</label>
                        <div class="image-preview p-2 d-inline-block">
                            <img src="{{ $introSlider->image_url }}" alt="Current Image" class="img-fluid" width="250">
                        </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select name="alignment" id="text_alignment" class="form-control">
                        <option value="left" {{ old('alignment', $introSlider->alignment ?? 'left') == 'left' ? 'selected' : '' }}>Left</option>
                        <option value="center" {{ old('alignment', $introSlider->alignment ?? 'left') == 'center' ? 'selected' : '' }}>Center</option>
                        <option value="right" {{ old('alignment', $introSlider->alignment ?? 'left') == 'right' ? 'selected' : '' }}>Right</option>
                    </select>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="background_color" class="form-label">Background Color</label>
                    <input type="color" name="background_color" id="background_color" class="form-control form-control-color" value="{{ old('background_color', $introSlider->background_color ?? '#ffffff') }}">
                    <small class="text-muted">Used if no image is set</small>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="text_color" class="form-label">Text Color</label>
                    <input type="color" name="text_color" id="text_color" class="form-control form-control-color" value="{{ old('text_color', $introSlider->text_color ?? '#000000') }}">
                </div>
            </div>

            <div class="mb-3">
                <label for="overlay_opacity" class="form-label">Image Overlay Opacity</label>
                <input type="number" name="overlay_opacity" id="overlay_opacity" class="form-control @error('overlay_opacity') is-invalid @enderror" value="{{ old('overlay_opacity', $introSlider->overlay_opacity ?? 0) }}" min="0" max="90">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="text" name="meta_title" id="meta_title" class="form-control @error('meta_title') is-invalid @enderror" value="{{ old('meta_title', $introSlider->meta_title) }}" placeholder="Leave empty to use slider title">
                @error('meta_title')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="mb-3">
                <label for="meta_description" class="form-label">Meta Description</label>
                <textarea name="meta_description" id="meta_description" class="form-control @error('meta_description') is-invalid @enderror" rows="2">{{ old('meta_description', $introSlider->meta_description) }}</textarea>
    ...
    <div class="d-flex gap-2 mb-3">
        ...
        <a href="{{ route('admin.slider-product.edit', $introSlider) }}" class="btn btn-success">Manage Product Details</a>
