            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Icon class for the phone support icon.</small>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="copyright_text" id="copyright_text" class="form-control @error('copyright_text') is-invalid @enderror" value="{{ old('copyright_text', $settings->copyright_text) }}" placeholder="Copyright © 2024 TwinVexa Technology BD. All Rights Reserved.">
