...
@section('header-title', 'Edit New Arrival Product')

@section('content')
<h2>Edit New Arrival Product</h2>

<form action="{{ route('admin.new-arrivals.update', $product) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <a href="{{ route('admin.new-arrivals.index') }}" class="btn btn-secondary">Cancel</a>
</form>
