...
@section('header-title', 'Manage New Arrivals')

@section('content')
<div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
    <h2>New Arrivals</h2>
    <a href="{{ route('admin.new-arrivals.create') }}" class="btn btn-primary">Add New Product</a>
</div>
...
<table class="table table-bordered align-middle">
    ...
    <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex flex-wrap gap-1">
                        <a href="{{ route('admin.new-arrivals.edit', $product) }}" class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('admin.new-arrivals.destroy', $product) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?')">
                            @csrf
                            @method('DELETE')
        ...
        @empty
            <tr>
                <td colspan="13" class="text-center py-4">No new arrival products found. <a href="{{ route('admin.new-arrivals.create') }}">Create your first new arrival product</a>.</td>
            </tr>
        @endforelse
    </tbody>
</table>
