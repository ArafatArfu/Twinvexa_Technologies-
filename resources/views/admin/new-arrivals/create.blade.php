...
@section('header-title', 'Add New Arrival Product')

@section('content')
<h2>Add New Arrival Product</h2>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="form-check">
                <input type="checkbox" name="is_sale" id="is_sale" class="form-check-input" value="1" {{ old('is_sale') ? 'checked' : '' }}>
