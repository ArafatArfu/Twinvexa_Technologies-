...
@section('header-title', 'Edit Recommendation Product')

@section('content')
<h2>Edit Recommendation Product</h2>

<form action="{{ route('admin.recommendations.update', $product) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $product->name) }}" required placeholder="e.g., Samsung Galaxy Note9, Bose SoundSport, GoPro Fusion 360">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <textarea name="short_description" id="short_description" class="form-control @error('short_description') is-invalid @enderror" rows="2" placeholder="Brief product summary shown on product cards...">{{ old('short_description', $product->short_description) }}</textarea>
    ...
    <a href="{{ route('admin.recommendations.index') }}" class="btn btn-secondary">Cancel</a>
</form>
