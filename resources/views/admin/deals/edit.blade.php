...
@section('header-title', 'Edit Deal Product')

@section('content')
<h2>Edit Deal Product</h2>

<form action="{{ route('admin.deals.update', $product) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="sku" id="sku" class="form-control @error('sku') is-invalid @enderror" value="{{ old('sku', $product->sku) }}" placeholder="e.g., DEAL-PROD-001">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select name="deal_label" id="deal_label" class="form-control @error('deal_label') is-invalid @enderror">
                        ...
                        <option value="Today's Deal" {{ old('deal_label', $product->deal_label) == "Today's Deal" ? 'selected' : '' }}>Today's Deal</option>
                        <option value="Hot Deal" {{ old('deal_label', $product->deal_label) == 'Hot Deal' ? 'selected' : '' }}>Hot Deal</option>
                        <option value="Outlet" {{ old('deal_label', $product->deal_label) == 'Outlet' ? 'selected' : '' }}>Outlet</option>
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" name="deal_start_date" id="deal_start_date" class="form-control @error('deal_start_date') is-invalid @enderror" value="{{ old('deal_start_date', $product->deal_start_date ? \Carbon\Carbon::parse($product->deal_start_date)->format('Y-m-d') : '') }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" name="deal_end_date" id="deal_end_date" class="form-control @error('deal_end_date') is-invalid @enderror" value="{{ old('deal_end_date', $product->deal_end_date ? \Carbon\Carbon::parse($product->deal_end_date)->format('Y-m-d') : '') }}">
