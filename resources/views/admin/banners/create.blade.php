...
@section('header-title', 'Add New Banner')
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="text" name="subtitle" id="subtitle" class="form-control @error('subtitle') is-invalid @enderror" value="{{ old('subtitle') }}" placeholder="e.g., Smart Offer, Time Deals, Clearance">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required placeholder="e.g., Samsung Galaxy Note9, Bose SoundSport, GoPro Fusion 360">
            ...
            <div class="mb-3">
                ...
                <textarea name="highlight_text" id="highlight_text" class="form-control @error('highlight_text') is-invalid @enderror" rows="2" placeholder="e.g., Save $150, Time Deal -30%, Save $70">{{ old('highlight_text') }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="button_link" id="button_link" class="form-control @error('button_link') is-invalid @enderror" value="{{ old('button_link') }}" placeholder="e.g., /banner-product/slug or https://example.com/product">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <small class="text-muted">Recommended size: 1140 x 380 px. Supported formats: JPG, PNG, WebP, SVG. Max 4MB.</small>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="color" name="background_color" id="background_color" class="form-control form-control-color @error('background_color') is-invalid @enderror" value="{{ old('background_color', '#ffffff') }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="color" name="text_color" id="text_color" class="form-control form-control-color @error('text_color') is-invalid @enderror" value="{{ old('text_color', '#333333') }}">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="text" name="seo_title" id="seo_title" class="form-control @error('seo_title') is-invalid @enderror" value="{{ old('seo_title') }}" placeholder="Leave empty to use banner title">
