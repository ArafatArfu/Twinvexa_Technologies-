...
@section('page_title', \App\Models\Setting::get('recommendations_title', 'Recommendation For You'))
@section('page_description', \App\Models\Setting::get('site_description', 'Recommended products picked just for you.'))
@section('canonical_url', route('recommendations.index'))
@section('og_title', \App\Models\Setting::get('recommendations_title', 'Recommendation For You'))
@section('og_description', \App\Models\Setting::get('site_description', 'Recommended products picked just for you.'))
...
<main class="main">
    <div class="page-header text-center" style="background-image: url('{{ asset('assets/images/page-header-bg.jpg') }}')">
        <div class="container">
            <h1 class="page-title">{{ \App\Models\Setting::get('recommendations_title', 'Recommendation For You') }}<span>Shop</span></h1>
        </div>
    </div>
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ \App\Models\Setting::get('recommendations_title', 'Recommendation For You') }}</li>
            </ol>
        </div>
    </nav>
