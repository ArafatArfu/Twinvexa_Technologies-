...
@section('page_title', \App\Models\Setting::get('site_name', 'Checkout'))
@section('page_description', \App\Models\Setting::get('site_description', 'Complete your purchase securely.'))
